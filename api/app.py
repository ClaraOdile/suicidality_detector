...
if st.button("Predict"):
    ...
    def classifier(max_val):
        if max_val == 4:
            return {'category' : 'Supportive', 'probability' : max_val_p, 'explanation' : 'The author of this text shows empathy toward another person regarding suicidality and offers help or advice'}
        elif max_val == 2:
